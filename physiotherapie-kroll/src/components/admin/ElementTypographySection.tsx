...
interface ElementTypographySectionProps {
  /** Block props with typography record */
  ...
  onChange: (elementId: string, typography: TypographySettings | null) => void
}

export function ElementTypographySection({
  blockProps,
  elementId,
  elementLabel,
  onChange,
}: ElementTypographySectionProps) {
  const typography = (blockProps.typography as Record<string, TypographySettings> | undefined)?.[elementId]
  const [localTypography, setLocalTypography] = useState<TypographySettings | null>(typography || null)
  ...
  const updateTypography = (updates: Partial<TypographySettings>) => {
    ...
    onChange(elementId, Object.keys(cleaned).length > 0 ? cleaned : null)
  }

  const handleReset = () => {
    setLocalTypography(null)
    onChange(elementId, null)
  }

  return (
    <AccordionItem value={elementId} className="border-none">
      <div className="flex items-center justify-between pr-4">
        <AccordionTrigger className="py-2 text-sm font-medium flex-1">
          {elementLabel}
        </AccordionTrigger>
        {localTypography && (
          <Button
      ...
      <AccordionContent className="pt-2 pb-4">
        <div className="space-y-3">
          ...
          <div className="space-y-1.5">
            <Label htmlFor={`typography-${elementId}-fontFamily`} className="text-xs">
              Schriftart
            </Label>
            <Select
            ...
            >
              <SelectTrigger id={`typography-${elementId}-fontFamily`} className="h-8 text-sm">
          ...
          {/* Font Weight */}
          <div className="space-y-1.5">
            <Label htmlFor={`typography-${elementId}-fontWeight`} className="text-xs">
              Schriftstärke
            </Label>
            <Select
            ...
            >
              <SelectTrigger id={`typography-${elementId}-fontWeight`} className="h-8 text-sm">
                <SelectValue placeholder="Standard" />
              </SelectTrigger>
              <SelectContent>
                <SelectItem value="__default__">Standard</SelectItem>
          ...
          {/* Font Size */}
          <div className="space-y-1.5">
            <Label htmlFor={`typography-${elementId}-fontSize`} className="text-xs">
              Schriftgröße
            </Label>
            <Select
            ...
            >
              <SelectTrigger id={`typography-${elementId}-fontSize`} className="h-8 text-sm">
                <SelectValue placeholder="Standard" />
              </SelectTrigger>
              <SelectContent>
                <SelectItem value="__default__">Standard</SelectItem>
          ...
          {/* Line Height */}
          <div className="space-y-1.5">
            <Label htmlFor={`typography-${elementId}-lineHeight`} className="text-xs">
              Zeilenhöhe
            </Label>
            <Select
            ...
            >
              <SelectTrigger id={`typography-${elementId}-lineHeight`} className="h-8 text-sm">
                <SelectValue placeholder="Standard" />
              </SelectTrigger>
              <SelectContent>
                <SelectItem value="__default__">Standard</SelectItem>
          ...
          {/* Letter Spacing */}
          <div className="space-y-1.5">
            <Label htmlFor={`typography-${elementId}-letterSpacing`} className="text-xs">
              Zeichenabstand
            </Label>
            <Select
            ...
            >
              <SelectTrigger id={`typography-${elementId}-letterSpacing`} className="h-8 text-sm">
                <SelectValue placeholder="Standard" />
              </SelectTrigger>
              <SelectContent>
                <SelectItem value="__default__">Standard</SelectItem>
          ...
          <div className="flex items-center justify-between">
            <Label htmlFor={`typography-${elementId}-italic`} className="text-xs">
              Kursiv
            </Label>
            <Switch
              id={`typography-${elementId}-italic`}

...
const heroBrandContentSchema = z.object({
  ...
  badgeRadiusPreset: z.enum(["pill", "lg", "md", "sm", "none"]).optional(),
  // Legacy/advanced
  badgeBorderRadius: z.string().optional(),
...
const panelPropsSchema = z.object({
  ...
  containerOpacity: z.number().optional(),
...
const imageSliderPropsSchema = z.object({
  ...
  cardsLightbox: z.boolean().optional().default(false),
  cardsLightboxBackdropPreset: z.enum(["soft-dark", "dark", "darker", "black"]).optional().default("darker"),
  cardsLightboxBackdropColor: z.string().optional(),
  cardsFirstImageLightbox: z.boolean().optional().default(false),
...
const imageSliderDefaults: ImageSliderBlock["props"] = {
  ...
  cardsLightboxBackdropColor: "#000000E6",
...
export const blockRegistry: Record<BlockType, BlockDefinition> = {
  hero: {
    ...
    inspectorFields: [
      ...
      },
      {
        ...
        label: "Badge Rahmenfarbe",
        type: "color",
        placeholder: "#308973",
      },
      {
        key: "badgeBorderRadius",
        label: "Badge Radius",
        type: "text",
        placeholder: "9999px / 16px",
      },
  ...
  imageSlider: {
    ...
    inspectorFields: [
      ...
      {
        key: "cardsLightbox",
        label: "Cards: Lightbox aktiv",
        type: "boolean",
        showWhen: { key: "variant", equals: "cards" },
        group: "interactions",
      },
      {
        key: "cardsLightboxBackdropColor",
        label: "Cards: Lightbox Hintergrund",
        type: "color",
      ...
      {
        key: "cardsLightboxBackdropPreset",
        label: "Cards: Lightbox Preset",
        type: "select",
        options: [
  ...
  courseSchedule: {
    ...
    inspectorFields: [
      ...
      { key: "eyebrow", label: "Eyebrow (optional)", type: "text", placeholder: "z.B. KURSE", group: "basics" },
      ...
      { key: "eyebrowColor", label: "Eyebrow Farbe", type: "color", placeholder: "#111111", group: "design" },
      { key: "headlineColor", label: "Überschrift Farbe", type: "color", placeholder: "#111111", group: "design" },

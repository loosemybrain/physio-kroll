...
/**
 * Homepage route - physio-konzept brand
 * Loads CMS page with slug "home" and brand "physio-konzept"
 */
export default async function KonzeptHomePage() {
  const supabasePublic = await getSupabasePublic();

  // Load a page with slug "home" and brand "physio-konzept"
  ...
  return (
    <>
      <HomePageClient blocks={cmsBlocks} initialBrand="physio-konzept" showBrandToggle={true} />
